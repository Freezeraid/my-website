...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    {
      href: 'https://github.com/Freezeraid/',
      label: 'GitHub',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-12 border-b border-gray-700">
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Développeur Web Freelance passionné et basé à Nice, je me spécialise dans la création de sites internet et applications web modernes et performantes avec React, Node.js, Golang, SQL, MongoDB ou WordPress.
            </p>
          </div>
            ...
            <div className="flex space-x-4">
              {socialLinks.map((link) => (
                <Link
                  ...
                  className={`${styles.socialLink} text-gray-400 hover:text-white`}
