        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-12 border-b border-gray-700">
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Développeur Web Freelance passionné et basé à Nice, je crée des sites et applications web modernes et performantes avec React, Node.js, Golang, SQL, MongoDB ou WordPress.
            </p>
          </div>
