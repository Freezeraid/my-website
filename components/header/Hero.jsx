          ...
          <div className="flex flex-col-reverse md:grid md:grid-cols-2 gap-6 md:gap-12 items-center">
            <div className="text-center md:text-left space-y-4 mt-6 md:mt-0">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-gray-600 leading-relaxed max-w-2xl mx-auto md:mx-0">
                Spécialisé dans la création de sites web et d'applications performantes, je transforme vos objectifs en sites web ou applications web qui se démarquent. De l'architecture à l'expérience utilisateur, chaque ligne de code est optimisée pour garantir votre succès.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start mt-8">
                <Link
                  href="#contact"
                  className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 rounded-full bg-blue-600 text-white font-medium hover:bg-blue-700 transition-colors transition-shadow duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 text-sm sm:text-base"
                >
                  Me contacter
                </Link>
                <Link
                  href="#services"
                  className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 rounded-full border-2 border-blue-600 text-blue-600 font-medium hover:bg-blue-50 transition-colors transition-transform duration-300 transform hover:-translate-y-0.5 text-sm sm:text-base"
                >
                  Voir mes services
                </Link>
              </div>
