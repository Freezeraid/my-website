  ...
  const webServices = [
    {
      ...
      description: "Conception et création de sites web sur-mesure pour les entreprises marseillaises. Des vitrines web modernes, responsive et optimisées pour convertir vos visiteurs en clients fidèles.",
      features: [
