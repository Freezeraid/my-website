...
export const metadata = {
  ...
  description: 'Développeur web freelance à Avignon spécialisé en création de sites web, e-commerce et applications. Solutions digitales adaptées aux entreprises et commerces avignonnais, avec accompagnement personnalisé.',
...
export default function DeveloppeurWebAvignonPage() {
  const webServices = [
    ...
    },
    {
      ...
      description: "Développement d'applications web et plateformes personnalisées pour digitaliser vos services et optimiser vos processus métier à Avignon, adaptées aux spécificités de votre secteur d'activité et aux particularités du marché local.",
      features: [
        ...
        <section className="py-24 bg-gradient-to-b from-white to-blue-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                J'utilise les technologies les plus modernes et performantes pour développer des solutions web de qualité pour les entreprises d'Avignon.
              </p>
            </div>
        ...
        <section className="py-16 bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Prêt à Développer Votre Projet Web à Avignon ?
            </h2>
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Contactez-moi dès aujourd'hui pour discuter de votre projet web et obtenir un devis personnalisé. 
              Ensemble, créons une solution web performante qui répond parfaitement aux besoins de votre entreprise dans cette ville culturelle et historique du Vaucluse.
            </p>
            <Link
              href="#contact"
