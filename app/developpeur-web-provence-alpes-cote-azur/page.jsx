...
export default function DeveloppeurWebProvenceAlpesCoteAzurPage() {
  const webServices = [
    ...
    },
    {
      ...
      description: "Développement d'applications web et plateformes personnalisées pour mettre en ligne vos services et optimiser vos processus métier en région PACA, adaptées aux spécificités de votre secteur d'activité.",
      features: [
