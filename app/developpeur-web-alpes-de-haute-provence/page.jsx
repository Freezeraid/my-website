...
export default function DeveloppeurWebAlpesDeHauteProvencePage() {
  const webServices = [
    {
      ...
      description: "Conception et création de sites web sur-mesure pour les entreprises et professionnels des Alpes-de-Haute-Provence. Des sites vitrines élégants, responsive et optimisés pour convertir vos visiteurs en clients et valoriser votre activité locale dans ce territoire entre Alpes et Provence.",
      features: [
    ...
    },
    {
      ...
      description: "Développement d'applications web et plateformes personnalisées pour mettre en ligne vos services et optimiser vos processus métier dans les Alpes-de-Haute-Provence, adaptées aux spécificités de votre secteur d'activité et aux particularités du territoire.",
      features: [
  ...
  const localAdvantages = [
    ...
    },
    {
      ...
      description: "Je vous propose un support technique réactif et une maintenance continue de votre site ou application. Mon intervention rapide garantit une présence web toujours opérationnelle, essentielle pour maintenir la confiance de vos clients dans les Alpes-de-Haute-Provence, même dans les zones rurales."
    }
  ]
  ...
  const workProcess = [
    ...
    },
    {
      ...
      description: "J'élabore une stratégie web sur-mesure et crée des maquettes détaillées de votre site ou application. Nous collaborons étroitement pour affiner le design et les fonctionnalités jusqu'à ce qu'ils correspondent parfaitement à votre vision et aux attentes de votre clientèle dans le 04."
    },
    {
      number: "03",
        ...
        <section className="py-24 bg-gradient-to-b from-white to-blue-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Quelques chiffres qui démontrent l'importance d'une présence web professionnelle pour les entreprises des Alpes-de-Haute-Provence, particulièrement dans ce territoire où la connectivité web permet de dépasser les contraintes géographiques.
              </p>
            </div>
        ...
        <section className="py-24 bg-gradient-to-b from-white to-blue-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Une approche méthodique et collaborative pour transformer votre vision en une solution web performante et adaptée au marché des Alpes-de-Haute-Provence et à ses spécificités territoriales.
              </p>
            </div>
