...
export default function DeveloppeurWebAlpesMaritimesPage() {
  const webServices = [
    ...
    },
    {
      ...
      description: "Développement d'applications web et plateformes personnalisées pour digitaliser vos services et optimiser vos processus métier dans les Alpes-Maritimes, adaptées aux spécificités de votre secteur d'activité.",
      features: [
  ...
  const localAdvantages = [
    ...
    },
    {
      ...
      description: "Je vous propose un support technique efficace et une maintenance continue de votre site ou application. Mon intervention rapide garantit une présence digitale toujours opérationnelle, essentielle pour maintenir la confiance de vos clients dans les Alpes-Maritimes."
    }
  ]
  ...
  const workProcess = [
    ...
    },
    {
      ...
      description: "J'élabore une stratégie digitale sur-mesure et crée des maquettes détaillées de votre site ou application. Nous collaborons étroitement pour affiner le design et les fonctionnalités jusqu'à ce qu'ils correspondent parfaitement à votre vision et aux attentes de votre clientèle dans le 06."
    },
    {
      number: "03",
        ...
        <section className="py-24 bg-gradient-to-b from-white to-blue-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Une approche méthodique et collaborative pour transformer votre vision en une solution digitale performante et adaptée au marché des Alpes-Maritimes.
              </p>
            </div>
