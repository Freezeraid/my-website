        ...
        <section className="py-16 bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Contactez-moi dès aujourd'hui pour discuter de votre projet SEO et obtenir un audit gratuit de votre site web. 
              Ensemble, développons une stratégie de référencement naturel qui propulsera votre site dans les premiers résultats de Google.
            </p>
            <Link
              href="#contact"
