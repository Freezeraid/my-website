 ...
 return (
   <main className="min-h-[calc(100vh-80px)] pt-20 bg-gradient-to-b from-blue-50 to-white">
     ...
     <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-10">
       <div className="bg-white rounded-t-2xl shadow-xl p-8 mb-8">
       ...
       <div className="bg-white shadow-xl rounded-b-2xl p-8">
         ...
         <div className="mt-12 pt-8 border-t">
           ...
           <Link
               href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(article.title)}&url=${encodeURIComponent(`https://killiandoubre.com/blog/${article.slug}`)}`}
               target="_blank"
            ...
            <Link
               href={`https://www.linkedin.com/shareArticle?mini=true&url=${encodeURIComponent(`https://killiandoubre.com/blog/${article.slug}`)}&title=${encodeURIComponent(article.title)}`}
               target="_blank"
               rel="noopener noreferrer"
               className="p-2 text-gray-600 hover:text-blue-600 transition-colors"
