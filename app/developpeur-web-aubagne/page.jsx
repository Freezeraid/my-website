...
export const metadata = {
  ...
  description: 'Développeur web freelance pour Aubagne spécialisé dans la création de sites web, e-commerce et applications. Solutions digitales sur-mesure pour entreprises aubagnaises avec accompagnement à distance et expertise technique.',
...
export default function DeveloppeurWebAubagnePage() {
  const webServices = [
    {
      ...
      description: "Création de sites web sur-mesure pour les entreprises et professionnels aubagnais. Des vitrines digitales modernes, responsive et optimisées pour convertir vos visiteurs en clients.",
      features: [
    ...
    },
    {
      ...
      description: "Conception d'applications web et plateformes sur-mesure pour digitaliser vos services et optimiser vos processus métier à Aubagne et dans les Bouches-du-Rhône.",
      features: [
  ...
  const aubagneBusinessSectors = [
    ...
    },
    {
      ...
      description: "Sites web et applications pour restaurants, producteurs locaux et commerces alimentaires d'Aubagne. Solutions digitales valorisant les produits du terroir provençal, avec systèmes de réservation et présentation attractive de votre offre."
    },
    {
      icon: "🏢",
